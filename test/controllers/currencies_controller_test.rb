...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { code: @currency.code, country_id: @currency.country_id, name: @currency.name } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { code: @currency.code, country_id: @currency.country_id, name: @currency.name } }
